...
【第三段范例——照这个狠度写】
· 好："bridge":"他忍下的那口气，就是你不敢发的那封辞职信"（具体、有痛感、两端咬合）
· 坏："bridge":"他的选择反映了人性的复杂"（正确的废话，放谁身上都成立，禁止这样写）
bridge 必须是"具体动作↔具体处境"的对折，不许出现"人性/成长/勇气/选择"这类抽象大词。
...
自检：把 image 和 question 换到任何一个玩家身上是否都成立？只要"通用"就重写，直到它只属于"这一局这个人"。image 必须是能拍成一帧画面的具体动作/场景，question 必须扎在最尖锐处、不含答案。
