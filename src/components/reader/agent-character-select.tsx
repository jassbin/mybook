  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 角色列表（可滚动）：点卡片直接进入 */}
        <div className="relative z-10 flex-1 min-h-0 overflow-y-auto px-5 pb-3">
        ...
        {/* 底部：其他角色自填 */}
        <div
          className="relative z-20 shrink-0 px-5 pt-3 pb-5 border-t"
          style={{ borderColor: "rgba(56,189,168,.2)" }}
        >
