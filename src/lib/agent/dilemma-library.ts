...
export const DILEMMA_LIBRARY: Dilemma[] = [
  ...
  // ── 补齐至 81 条 ──────────────────────────────────────────
  {
    ...
    domain: "家庭代际",
    core: "圆谎 vs 说真话",
    modernContext: "长辈问起那件他们绝不能接受的事，一句谎能保全所有人的平静",
    modernTag: "报喜不报忧",
    intensity: 2,
    storyAppeal: 3,
    modernTension: "「懂事」常常意味着独自消化真相，把体面留给别人、把孤独留给自己",
  },
  {
    id: "id-09",
    domain: "身份认同",
    core: "追随热爱 vs 稳妥人生",
    modernContext: "那件让你眼睛发亮的事不赚钱也没面子，稳妥的那条路一眼能望到退休",
    modernTag: "热爱与饭碗",
    intensity: 2,
    storyAppeal: 3,
    modernTension: "「务实」是最体面的放弃——它让你在多年后，说不清究竟是选择了生活还是背叛了自己",
  },
  {
    id: "su-09",
    domain: "生存底线",
    core: "揭发恩人 vs 包庇罪行",
    modernContext: "你查到的那个人，正是当年拉过你一把的恩人，而他确实做了错事",
    modernTag: "恩义与是非",
    intensity: 3,
    extremeVersion: "揭发他，你就是忘恩负义；包庇他，你就成了共犯",
    storyAppeal: 5,
    modernTension: "当私恩与公义正面相撞，「做个好人」这件事本身就变成了没有正确答案的陷阱",
  },
  {
    id: "wp-11",
    domain: "职场权力",
    core: "抢先出手 vs 守住信义",
    modernContext: "你知道对方也在盯这个位置，先下手你就赢，但要踩着一起打拼过的伙伴",
    modernTag: "同袍变对手",
    intensity: 3,
    extremeVersion: "你不动手，明天被踩下去的就是你",
    storyAppeal: 5,
    modernTension: "零和的赛道会把「情义」重新定义为「软弱」，逼着好人先变成自己讨厌的样子",
  },
  {
    id: "re-14",
    domain: "感情关系",
    core: "陪伴病榻 vs 奔赴前程",
    modernContext: "他病了需要你守着，可你等了半生的机会也正好在此刻降临",
    modernTag: "爱与自我的拉锯",
    intensity: 3,
    extremeVersion: "留下，你的人生就停在这里；离开，你可能再也见不到他最后一面",
    storyAppeal: 5,
    modernTension: "「陪伴」被默认为爱的最高证明，却很少有人问：牺牲掉的那个人生，算不算另一种死亡",
  },
  {
    id: "fate-09",
    domain: "命运偏爱",
    core: "顶替名额 vs 让给更需要的人",
    modernContext: "那个改变命运的名额到了你手里，可你知道另一个人比你更需要、也更够格",
    modernTag: "命运的插队",
    intensity: 2,
    extremeVersion: "你收下，他这辈子就再没机会了",
    storyAppeal: 4,
    modernTension: "命运的馈赠常常是零和的——你的「好运」，可能正踩在另一个人被夺走的机会上",
  },
  {
    id: "taboo-10",
    domain: "禁忌诱惑",
    core: "揭开真相 vs 维持幸福的谎",
    modernContext: "你能证明现在的美满全建立在一个谎言上，可戳破它，所有人都会碎",
    modernTag: "幸福的赝品",
    intensity: 3,
    extremeVersion: "说出真相，你亲手毁掉所有人的幸福；不说，你要替所有人守一辈子的谎",
    storyAppeal: 5,
    modernTension: "「无知即幸福」是最诱人的共谋——而那个知道真相的人，从此再也回不去了",
  },
  {
    id: "betray-10",
    domain: "背叛信任",
    core: "替人顶罪 vs 保全自己",
    modernContext: "他求你替他扛下这件事，念在往日情分，你几乎要点头了",
    modernTag: "情分的账单",
    intensity: 3,
    extremeVersion: "顶了，你搭上前途；不顶，你们的情分就此清零，他也会恨你",
    storyAppeal: 4,
    modernTension: "以「情分」之名索取牺牲，是最难拒绝的绑架——因为拒绝的代价，是被判定为「不够朋友」",
  },
];
