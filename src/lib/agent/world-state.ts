...
export const META_AXES: MetaAxis[] = [
  ...
  {
    id: "indulgence_vs_restraint",
    label: "享乐克制",
    description: "面对诱惑和当下的舒适，你更倾向即时满足，还是为长远而自律克制",
    keywords: ["诱惑", "享乐", "克制", "欲望", "当下", "长远", "自律", "放纵", "舒适", "禁忌"],
  },
  {
    id: "reason_vs_feeling",
    label: "理性感性",
    description: "做决定时，你更相信逻辑推演和利弊计算，还是情感直觉和心之所向",
    keywords: ["理性", "感性", "逻辑", "计算", "直觉", "情感", "心动", "权衡", "冲动", "算计"],
  },
];
