...
# 第5页 亮点
content_page(5, "从“照见自己”，到“互相看见”", None, None, [
    ("两个人各走一遍 · 照见我们", [
        "情侣 / 朋友 / 同事读同一本书、附身同一个角色，并排看两份价值观画像：我们哪里像、哪里不一样、为什么",
    ]),
    ("一群人共读一本 · 互相看见", [
        "读书会 / 班级 / 家庭各走一遍同一角色，聚在一起看：谁的选择最不一样，那个“异类”背后是什么价值观",
    ]),
    ("一条成长曲线 · 看见自己的变化", [
        "多次游玩沉淀成一条价值观轨迹——半年后回看，“我，变了没有？”",
    ]),
], "从“读一本书”，到“一群人借一本书，照见彼此”——书，成了人与人之间那面共同的镜子。")
